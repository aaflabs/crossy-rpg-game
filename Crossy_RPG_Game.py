...
class Game:
    ...
    def __init__(self, image_path, title, width, height) -> None:
        self.title = title
        self.width = width
        self.height = height
    ...
    def run_game_loop(self, speed_level):
        ...
        if did_win:
            self.run_game_loop(speed_level + 0.5)
        else:
            return
...
new_game = Game('background.png',SCREEN_TITLE,SCREEN_WITH,SCREEN_HEIGHT)
